...
pub fn t_N(i:usize, j:usize, n:usize) -> f64{
    ...
    while count < t1_upper_bound{
        t1 += 4.0_f64.powf(count) * I((((i % (n/2.0)) - 1.0) % 
        2.0_f64.powf(count+1.0))+1.0 > 2.0_f64.powf(count));
        count += 1.0;
    }
    ...
    while count < t2_upper_bound{
        t2 += 4.0_f64.powf(count) * I((((j % (n/2.0)) - 1.0) % 
        2.0_f64.powf(count+1.0))+1.0 > 2.0_f64.powf(count));
        count += 1.0;
    }
...
pub fn g_T(i:usize, j:usize, n:usize) -> f64{
    ...
    while k < t3_upper_bound{
        t3 += 4.0_f64.powf(k) * 
              I((((i%2.0*n)-1.0 )%
              2.0_f64.powf(k+1.0))+1.0 > 2.0_f64.powf(k));
        k += 1.0;
    }
...
pub fn g_AB(i:f64, j:f64, n:f64) -> f64{
    ...
    let t1 = 3.0*2.0_f64.powf(2.0*n.log2()+1.0) + (2.0_f64.powf(2.0*n.log2()-1.0))*I(i<=n/2.0 && n/4.0 < j && j <= n/2.0);
    let t2 = (3.0*2.0_f64.powf(2.0*n.log2()-1.0)) * I(i<=n/2.0 && n/2.0 < j && j <= 3.0*n/4.0);
    let t3 = (3.0*2.0_f64.powf(2.0*n.log2()-1.0)) * I(n/2.0 < i && i<= n && n/4.0 < j && j <= n/2.0);
    let t4 = (2.0_f64.powf(2.0*n.log2()-1.0)) * I(n/2.0 < i && i < n && n/2.0 < j && j <= 3.0*n/4.0);
    let t5 = I(i <= n/2.0 && j <= n/4.0) * g_AB(i,j,n/2.0);
    let t6 = I(n/2.0 < i && i <= n && j <= n/4.0) * (n*n + g_AB(i-n/2.0,j,n/2.0));
    let t7 = I(i<= n/2.0 && 3.0*n/4.0 < j && j <= n) * (n*n + g_AB(i,j-n/2.0, n/2.0));
    let t8 = I(n/2.0 < i && i <= n && 3.0*n/4.0 < j && j <= n) * g_AB(i-n/2.0,j-n/2.0,n/2.0);
